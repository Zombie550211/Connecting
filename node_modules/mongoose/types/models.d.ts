...
const Lead = require('./models/lead');         // Asegúrate que fecha es String en el modelo
const Costumer = require('./models/costumer'); // Asegúrate que fecha es String en el modelo
...
// Middleware para proteger rutas y manejar expiración de sesión
function protegerRuta(req, res, next) {
  const MAX_INACTIVIDAD = 30 * 60 * 1000; // 30 minutos
